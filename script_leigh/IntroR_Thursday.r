...
#### Run up to line 111, then answer the questions
#
# 1) What does your advisor (generally) do to the data before line 94? (3 things)
#    a)
#    b)
#    c)
#     
# 2) What happened to the variable "df" between lines 96-105?
#
#
...
#  
#
#### Run the rest of the lines (after 111)
